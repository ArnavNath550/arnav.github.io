...
const PerformanceAnimation: React.FC = () => {
      ...
      {motionShift ? (
        ...
        >
          {Array.from({ length: LINES }, (_i, index) => {
            return <StyledPerformanceBlock isEven={index % 2 == 0} />;
          })}
        </StyledPerformanceAnimation>
      )}
    </motion.span>
...
const StyledPerformanceAnimation = styled(motion.span)`
  display: flex;
  flex-direction: row;
`;

const StyledPerformanceBlock = styled.p<{ isEven: boolean }>`
